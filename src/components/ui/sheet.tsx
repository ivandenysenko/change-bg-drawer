...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="cursor-pointer ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-8 right-5 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn(
        "text-foreground text-[22px] leading-[1.2] font-bold",
        className
      )}
      {...props}
    />
